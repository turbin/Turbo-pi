...
日期：2026-07-23
任务书：`doc/design/2026-07-23-agent-server-r-real-teacher-tasks.md` R3
数据基础：R1（`doc/design/2026-07-23-agent-server-r1-real-teacher-e2e-changes-and-decisions.md`）、R2（`doc/design/2026-07-23-agent-server-r2-mock-vs-real-evaluation.md`）
...
`doc/design/2026-07-23-agent-server-observation-runbook.md` §3 动作表两处修订：
...
Refer Spec：`doc/design/2026-07-23-agent-server-r-real-teacher-tasks.md`（R3）；`doc/design/2026-07-22-agent-server-c-ability-distillation-design-and-tasks.md`（决策 1）；`doc/design/2026-07-23-agent-server-r2-mock-vs-real-evaluation.md`（数据与触发评审）；`doc/design/2026-07-23-agent-server-observation-runbook.md`（触发条件与本次修订）
