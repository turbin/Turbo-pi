...
Refs: `doc/design/2026-07-19-agent-server-p1-spec.md` §3.1/§4.1, `doc/design/2026-07-19-agent-server-p1-plan.md` Task 2,
`doc/design/2026-07-20-agent-server-task1-skill-catalog-changes-and-decisions.md`
