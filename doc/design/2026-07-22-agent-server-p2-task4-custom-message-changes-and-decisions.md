...
来源：P1 最终评审 finding 23（记录的请求消息是注入前的；spec §6 的 custom_message 未实现，重放会话不反映模型实际看到的上下文），见 `doc/design/2026-07-21-agent-server-p1-closeout-and-p2-followups.md` P2 事项 3
