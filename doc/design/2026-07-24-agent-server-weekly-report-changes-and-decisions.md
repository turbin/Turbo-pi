...
Refer Spec：`doc/design/2026-07-23-agent-server-observation-runbook.md`；`doc/design/2026-07-23-agent-server-r3-c-heavy-review.md`（触发评审正式结论）；`doc/design/2026-07-24-agent-server-n2-closeout-deepseek-teacher-changes-and-decisions.md`
