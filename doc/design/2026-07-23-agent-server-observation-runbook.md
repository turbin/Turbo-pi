...
基线文档：`doc/design/2026-07-23-agent-server-c3-observation-baseline.md`（2026-07-23 follow-up 刷新版）
元原则来源：`doc/design/2026-07-22-agent-server-c-ability-distillation-design-and-tasks.md`（"所有决策暂定，上线运行后按观察基线迭代"）
...
- 决策记录：`doc/design/2026-07-24-agent-server-weekly-report-changes-and-decisions.md`。
...
| ABILITY 自然产量连续 4 周为 0（真实 teacher 口径，R3 修订） | 关键词门控是否过严、session 数据是否足够多样 | 决策 1（C-轻路径） | 评审是否需要 C-重（独立 LLM 提炼管线）。**R3 已评审一次：No-Go**（真实 teacher 单轮 4 Method，C-轻成立），重启条件见 `doc/design/2026-07-23-agent-server-r3-c-heavy-review.md` |
...
本 runbook 引用的基线数据来自 `doc/design/2026-07-23-agent-server-c3-observation-baseline.md`（2026-07-23 follow-up 刷新版），关键数字：
