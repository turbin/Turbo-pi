...
Refer Spec：`doc/design/2026-07-22-agent-server-c-ability-distillation-design-and-tasks.md`（通用约束）；`doc/design/2026-07-22-agent-server-b3-evolution-scheduling-changes-and-decisions.md`（loop 模式出处）
