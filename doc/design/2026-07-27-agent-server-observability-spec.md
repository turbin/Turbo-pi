...
上游：观察期需要量化"本地经验库到底有没有被用上"——这是 replay 机制评估（`doc/design/2026-07-25-agent-server-eval-report-design.md` L3 层）的数据基础。
...
Refer Spec：本文件；`doc/design/2026-07-25-agent-server-eval-report-design.md`（L3 指标来源）
