...
日期：2026-07-23
任务书：`doc/design/2026-07-23-agent-server-post-c-tasks.md` N3 节
...
3. 观察 runbook（`doc/design/2026-07-23-agent-server-observation-runbook.md`）。
...
观察 runbook 已落盘 `doc/design/2026-07-23-agent-server-observation-runbook.md`，内容：
