...
通用约束：见 `doc/design/2026-07-22-agent-server-p3-candidate-tasks.md`"通用约束"。
...
Refer Spec：`doc/design/2026-07-23-agent-server-post-c-tasks.md`（N2/N3）；`doc/design/2026-07-23-agent-server-n2-docker-build-changes-and-decisions.md`；`doc/design/2026-07-23-agent-server-n3-go-live-changes-and-decisions.md`；`doc/design/2026-07-23-agent-server-r2-mock-vs-real-evaluation.md`（teacher 切换指令，DeepSeek 取代其中的 omlx 方案）
