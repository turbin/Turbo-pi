...
状态：已收口
任务书：`doc/design/2026-07-23-agent-server-r-real-teacher-tasks.md`
...
|---|---|---|---|---|
| R1 真实 LLM teacher 全链路 E2E 验证（含 rescore 超时治理） | done | kimi | 2026-07-23T22:25+08:00 | 决策记录 `doc/design/2026-07-23-agent-server-r1-real-teacher-e2e-changes-and-decisions.md`；checkpoint ckpt-82fbef5131817d6c metric=4；rescore 未触发暂不治理 |
| R2 Mock vs 真实对照评估与 teacher 切换建议 | done | kimi | 2026-07-23T22:45+08:00 | 评估报告 `doc/design/2026-07-23-agent-server-r2-mock-vs-real-evaluation.md`；基线已刷新为真实 teacher 版；切换指令交付（用户动作） |
| R3 C-重 Go/No-Go 评审 | done | kimi | 2026-07-23T23:00+08:00 | 评审报告 `doc/design/2026-07-23-agent-server-r3-c-heavy-review.md`：**No-Go**（真实 teacher 单轮 4 Method，C-轻成立）；两触发评审正式结论；runbook §3 判读规则修订 |
