...
- Decision records go to `doc/design/<date>-<topic>-changes-and-decisions.md`; commit messages use the user's `COMPLETED：/TODO：/Refer Spec：` format with a conventional prefix (e.g. `feat(agent-server): …`).
