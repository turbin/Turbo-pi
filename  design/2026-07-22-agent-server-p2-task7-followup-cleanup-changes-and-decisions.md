...
日期：2026-07-22
范围：agent-server 的 Python 三条 CLI、offline 管线/verifier/checkpoint、session-writer、openai-compat、相关测试、` design/2026-07-19-agent-server-p1-spec.md` §6
来源：` design/2026-07-21-agent-server-p1-closeout-and-p2-followups.md` 低优先级 follow-up 清单 + Task 6 发现的 OpenAICompatClient role bug
