...
验收依据：` design/2026-07-22-agent-server-c-ability-distillation-design-and-tasks.md` §C3（3 个 BDD 场景）+ CLAUDE.md 测试要求 + 通用约束
...
Refer Spec：` design/2026-07-22-agent-server-c-ability-distillation-design-and-tasks.md`；` design/2026-07-23-agent-server-c3-live-verification.md`；` design/2026-07-23-agent-server-c3-observation-baseline.md`
