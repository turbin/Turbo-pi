...
- 方法参照 ` design/2026-07-22-agent-server-p2-live-verification.md`（MockLLM + 真实 `var/sessions` 跑 `runDailyEvolution`，再起 agent-server 发非流式请求）。
...
- 验收：live 验证文档 + 观察基线文档落 ` design/`（带前导空格），3 个 BDD 场景逐一对应执行记录；同提交更新 ` design/INDEX.md`。
