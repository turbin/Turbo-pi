...
日期：2026-07-24
任务书：` design/2026-07-24-agent-server-eval-benchmark-tasks.md` E0 节
...
Refer Spec：` design/2026-07-24-agent-server-eval-benchmark-tasks.md`（E0）；` design/2026-07-19-agent-server-task5-openai-compat-changes-and-decisions.md`（自包含映射器原决策）
