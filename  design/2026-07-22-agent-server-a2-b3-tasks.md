...
完整通用约束见 ` design/2026-07-22-agent-server-p3-candidate-tasks.md` 的"通用约束"一节，**全部适用**，要点重述：
...
- 每任务 = 1 个提交（实现 + 测试 + 决策记录文档，≤3000 行）；决策记录落 ` design/<date>-agent-server-<任务号>-*-changes-and-decisions.md`（目录名带前导空格）。
