...
**2026-07-23 R2 真实 teacher 刷新**：R1 真实 LLM teacher run（checkpoint `ckpt-82fbef5131817d6c`，omlx gemma-4-12B-it-4bit）后，本文档再次刷新为当前值，Mock 时代数字保留作历史对照（「原值 → 新值」）。对照分析见 ` design/2026-07-23-agent-server-r2-mock-vs-real-evaluation.md`。
